...
const InfoComponent: FC<IProps> = ({ data }) => {
  ...
  const t = useTranslations('ExploreCourse.Detail');
    ...
    <>
      <div className="h-[665px] md:h-[615px]">
        <div className="absolute inset-0 -z-10">
          <img src="/explore-course/course.png" alt="background" className="w-full object-cover" />
        </div>
        <div className="pt-[120px]">
          <Button onClick={() => router.back()} startIcon={<ChevronLeft />} sx={{ color: 'white' }}>
