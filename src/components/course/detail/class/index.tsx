...
const ClassesComponent: FC<IProps> = ({ data }) => {
  ...
  const t = useTranslations('ExploreCourse.Detail.Class');
  const currentLocal = locale as string;

  const CourseBenefits = [
    {
      img: '/explore-course/open-class.png',
      title: t('open'),
      description: (
    ...
    {
      img: '/explore-course/end-class.png',
      title: t('end'),
      description: (
        <Typography color="textPrimary" variant="body1" fontWeight={'medium'} className="flex flex-row gap-2">
          <AccessTimeFilled color="action" sx={{ fontSize: '16px' }} />
    ...
    {
      img: '/explore-course/total-hours.png',
      title: t('total.title'),
      description: (
        <Typography color="textPrimary" variant="body1" fontWeight={'medium'} className="flex flex-row gap-2">
          <AccessTimeFilled color="action" sx={{ fontSize: '16px' }} />
    ...
    {
      img: '/explore-course/certificate.png',
