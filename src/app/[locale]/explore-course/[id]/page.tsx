...
import { fetchCourseDetail, fetchCourseDetailByIndex } from '@/service/explore-course';

const CourseDetailComponent = dynamic(() => import('@/components/course/detail/index'));
